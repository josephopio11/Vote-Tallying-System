...
<div class="container">
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
            ...
            <?= form_open(voters_url('auth/login'), ' class="needs-validation form-signin crud4form" id="loginForm" data-packagelist=""'); ?>
        ...
        <div class="card-footer text-center">
             <a class="d-block small" href="<?=voters_url('auth/forgot');?>"><?= lang('auth.askResetPassword'); ?></a>
                    </div>
