...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = voters_url('pollstat/showForm/pollstat');           
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-dark bg-white o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= voters_url('pollstat/readStatistic/pollstat/Polling-Stations');?>" 
...
<?php echo form_open(voters_url('pollstat/readPollstat/pollstat'), 'id="form_pollstat"'); ?>
      ...
      data-getrelationurl="'. voters_url('pollstat/getAllParish') . '"
...
'); ?>
            ...
            <?=lang('pollstat.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=voters_url('pollstat/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_pollstat" class="table table-hover" width="100%" cellspacing="0" data-url="<?=voters_url('pollstat/readPollstat/pollstat');?>"></table>
            </div>
...
<script src="<?= voters_url('pollstat/langJS');?>"></script>

    <script src="<?= site_url('assets/voters/pollstat/pollstat.js');?>"></script> 
