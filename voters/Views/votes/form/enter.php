...
$url = voters_url('votes/save/enter');
$hiddenArray = [];
...
$form_attr = 'id="enter" autocomplete="off" role="presentation" data-pageslug="enter" data-formslug="enter"  data-jsname="enter" data-modalsize="lg" data-packagelist="selectpicker,popover,select2_js,uisortable,dropzone" data-closeonsave="true" class="bg-white crud4form"';

echo form_open($url, $form_attr, $hiddenArray); 
?>

<?=form_input("_formSlug", $formData['_formSlug'] ?? "enter", '', 'hidden');?> 
<?=form_input("_pageSlug", $formData['_pageSlug'] ?? "enter", '', 'hidden');?> 
<?=form_input("id", $formData['id'] ?? "", '', 'hidden');?> 

<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fas fa-pen-alt"></i> <?=lang('votes._form_enter'); ?> </h5>
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-minimuminputlength="0" data-formname="enter"
      ...
      data-required ="required" id="districtid8320" data-newinputname="new_districtid""
      ...
      data-required ="required" id="subcountyid4533" data-newinputname="new_subcountyid""
      ...
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="parishid6456" data-newinputname="new_parishid""
      ...
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="pollstatid7641" data-newinputname="new_pollstatid""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {id}"    data-filter="parishid as parishid"'); ?>
         ...
         <div class="form-group" id="groupField_evidence">
            <label for="evidence" class="required col-form-label"><i class="fas fa-file-image"></i>  <?=lang('votes.evidence'); ?></label>
                ...
                <div class="dropzone sortable" action="<?=voters_url("votes/uploadFile/enter/evidence");?>" 
                    data-maxfiles = "1" 
      ...
      data-required ="required" id="userid1945" data-newinputname="new_userid""
