...
$url = voters_url('votes/save/admin');
$hiddenArray = [];
...
$form_attr = 'id="admin" autocomplete="off" role="presentation" data-pageslug="admin" data-formslug="admin"  data-jsname="admin" data-modalsize="lg" data-packagelist="selectpicker,popover,select2_js,uisortable,dropzone" data-closeonsave="true" class="bg-white crud4form"';
...
<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fas fa-user-cog"></i> <?=lang('votes._form_admin'); ?> </h5>
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-minimuminputlength="0" data-formname="admin"
      ...
      data-required ="required" id="districtid4900" data-newinputname="new_districtid""
      ...
      data-required ="required" id="subcountyid4828" data-newinputname="new_subcountyid""
      ...
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="parishid4556" data-newinputname="new_parishid""
      ...
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="pollstatid2515" data-newinputname="new_pollstatid""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {id}"    data-filter="parishid as parishid"'); ?>
         ...
         <div class="form-group" id="groupField_evidence">
            <label for="evidence" class="required col-form-label"><i class="fas fa-file-image"></i>  <?=lang('votes.evidence'); ?></label>
                ...
                <div class="dropzone sortable" action="<?=voters_url("votes/uploadFile/admin/evidence");?>" 
                    data-maxfiles = "1" 
      ...
      data-required ="required" id="userid1248" data-newinputname="new_userid""
