...
$url = voters_url('county/save/county');
$hiddenArray = [];
...
<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fab fa-app-store"></i> <?=lang('county._form_county'); ?> </h5>
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-required ="required" id="zoneid5214" data-newinputname="new_zoneid""
