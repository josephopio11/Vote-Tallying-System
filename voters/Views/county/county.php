...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = voters_url('county/showForm/county');           
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-secondary o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= voters_url('county/readStatistic/county/Counties');?>" 
...
<?php echo form_open(voters_url('county/readCounty/county'), 'id="form_county"'); ?>
      ...
      id="search_zoneid"
      data-ajax--url="'. voters_url('county/getAllC4_zone') . '"
      data-getrelationurl="'. voters_url('county/getAllC4_zone') . '"
...
'); ?>
            ...
            <?=lang('county.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=voters_url('county/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_county" class="table table-hover" width="100%" cellspacing="0" data-url="<?=voters_url('county/readCounty/county');?>"></table>
            </div>
...
<script src="<?= voters_url('county/langJS');?>"></script>

    <script src="<?= site_url('assets/voters/county/county.js');?>"></script> 
