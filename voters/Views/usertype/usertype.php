...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = voters_url('usertype/showForm/usertype');           
...
<?php echo form_open(voters_url('usertype/readUsertype/usertype'), 'id="form_usertype"'); ?>
            ...
            <?=lang('usertype.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=voters_url('usertype/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_usertype" class="table table-hover" width="100%" cellspacing="0" data-url="<?=voters_url('usertype/readUsertype/usertype');?>"></table>
            </div>
...
<script src="<?= voters_url('usertype/langJS');?>"></script>

    <script src="<?= site_url('assets/voters/usertype/usertype.js');?>"></script> 
