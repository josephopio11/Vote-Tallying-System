        ...
        <div class="col">
            ...
            <div class="form-group" id="groupField_files" >
                ...
                <div class="input-group">
                    ...
                    <div class="dropzone sortable" action="<?= voters_url("home/uploadFile/email_send/files"); ?>" 
                         data-maxfiles = "5" 
                         id="drop_files" 
                                ...
                                <div class="dz-preview dz-processing dz-image-preview dz-success dz-complete" data-id="<?php echo $file_id; ?>" id="<?php echo $file_id; ?>">  
                                    ...
                                    <div>    
                                        <div class="pt-1 align-middle text-center">
                                            <a href="<?= voters_url("email_sended/deleteFile/$file_id"); ?>" id="file_<?= $file_id; ?>" 
                                                ...
                                                data-jsname="<?= $jsname; ?>"
                                                data-actionurl="<?= voters_url("email_sended/deleteFile/$file_id"); ?>" 
                                                title="Delete" 
...
<div class="modal-footer">
    ...
    <?php if ($type === 'multiple') : ?>
        <a class="btn btn-sm btn-danger ml-1" href="javascript:;"
           ...
           data-actionurl= "<?= voters_url('home/sendEmail'); ?>"
           data-datatable="<?= $datatable; ?>"
           data-jsname="<?= $jsname; ?>"
