...
$url = voters_url('c4_subscription/save/c4_subscription');
$hiddenArray = [];
...
$form_attr = 'id="c4_subscription" autocomplete="off" role="presentation" data-pageslug="c4_subscription" data-formslug="c4_subscription"  data-jsname="c4_subscription" data-modalsize="lg" data-packagelist="selectpicker,popover,datepicker,select2_js" data-closeonsave="true" class="bg-white crud4form"';
...
<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fab fa-amazon-pay"></i> <?=lang('c4_subscription._form_c4_subscription'); ?> </h5>
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-required ="required" id="company_id3781" data-newinputname="new_company_id""
