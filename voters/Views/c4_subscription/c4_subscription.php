...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fab fa-amazon-pay"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = voters_url('c4_subscription/showForm/c4_subscription');           
...
<?php echo form_open(voters_url('c4_subscription/readC4_subscription/c4_subscription'), 'id="form_c4_subscription"'); ?>
      ...
      data-ajax--url="'. voters_url('c4_subscription/getAllCompany') . '"
      data-getrelationurl="'. voters_url('c4_subscription/getAllCompany') . '"
...
'); ?>
            ...
            <?=lang('c4_subscription.subscription_status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=voters_url('c4_subscription/update');?>"
                    ...
                    <div class="btn-group btn-group-sm ml-2 delete_link" role="group">
                        ...
                        data-action="show_dt_replace"
                        data-actionurl= "<?=voters_url('c4_subscription/delete');?>"
                        data-datatable="table_c4_subscription" data-jsname="c4_subscription"
                        data-question="<?=lang("home.areyousure");?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_c4_subscription" class="table table-hover" width="100%" cellspacing="0" data-url="<?=voters_url('c4_subscription/readC4_subscription/c4_subscription');?>"></table>
            </div>
...
<script src="<?= voters_url('c4_subscription/langJS');?>"></script>

    <script src="<?= site_url('assets/voters/c4_subscription/c4_subscription.js');?>"></script> 
