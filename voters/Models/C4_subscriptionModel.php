...
class C4_subscriptionModel extends Model
{
    ...
    protected $allowedFields  = ["c4_subscription_id","subscription_status","due_date","company_id","plan_duration","trail_start_date","trial_end_date","subscription_start_date","subscription_end_date","created_at","updated_at"];
