...
<div class="container">
    ...
    $url                    = agents_url('home/accountsave/personel/'. $memberId);
                        ...
                        <div class="input-group">
                            ...
                            <label class="label labelcropper" data-toggle="tooltip" style="cursor: pointer;">
                                ...
                                <input type="file" name="file" accept="image/*" class="sr-only cropperjs" id="input_<?= $randomID; ?>" 
                                       data-action="<?= agents_url("home/uploadFile/account/avatar"); ?>" data-inputname="avatar" 
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-auto">
                    ...
                    <a class="btn btn-primary btn-lg btn-block" 
                       href="<?= agents_url('home/showForm/change_password/'. $memberId); ?>" 
                       data-modalsize="lg" 
                       data-modalurl="<?= agents_url('home/showForm/change_password/'. $memberId); ?>" 
