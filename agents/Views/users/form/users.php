...
$url = agents_url('users/save/users');
$hiddenArray = [];
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-ajax--url="'. agents_url('users/getAllUsertype') . '" 
      ...
      data-required ="required" id="usertype1268" data-newinputname="new_usertype""
...
<div class="input-group">
    ...
    <label class="label labelcropper" data-toggle="tooltip" title="<?=lang("users.avatar_helpText")?>" style="cursor: pointer;">
        ...
        <input type="file" name="file" accept="image/*" class="sr-only cropperjs" id="input_<?=$randomID;?>" 
            data-action="<?=agents_url("users/uploadFile/users/avatar");?>" data-inputname="avatar" data-idnumber="<?=$randomID;?>" 
