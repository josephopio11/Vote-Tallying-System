...
<body id="page-top" class="sidebar-toggled">
    ...
    <nav class="navbartop navbar navbar-expand  navbar-header static-top shadow-sm bg-white rounded">
        ...
        <a class="navbar-brand p-1 mr-1 text-center toggled" href="<?=agents_url('home/index');?>">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="<?=agents_url('home/account/personel');?>"><?=lang('home.account');?></a>
                        <a class="dropdown-item" href="<?=agents_url('auth/logout');?>" data-toggle="modal" data-target="#logoutModal"><?=lang('home.logout');?></a>
                    </div>
                </li>
...
<?php echo agents_view('themes/veboTheme/menu-part'); ?>
    </ul>
    <!-- / Sidebar -->
