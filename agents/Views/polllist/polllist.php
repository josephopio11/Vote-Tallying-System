...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = agents_url('polllist/showForm/polllist');           
...
<?php echo form_open(agents_url('polllist/readPolllist/polllist'), 'id="form_polllist"'); ?>
      ...
      data-getrelationurl="'. agents_url('polllist/getAllPollstat') . '"
...
'); ?>
      ...
      data-getrelationurl="'. agents_url('polllist/getAllParish') . '"
      data-placeholder="'. lang('home.all') . '" 
      data-theme="bootstrap4" 
      data-selectonclose="true"
      data-minimuminputlength="0"
...
'); ?>
      ...
      data-getrelationurl="'. agents_url('polllist/getAllSubcounty') . '"
      data-placeholder="'. lang('home.all') . '" 
      data-theme="bootstrap4" 
      data-selectonclose="true"
      data-minimuminputlength="0"
...
'); ?>
      ...
      data-getrelationurl="'. agents_url('polllist/getAllCounty') . '"
      data-placeholder="'. lang('home.all') . '" 
      data-theme="bootstrap4" 
      data-selectonclose="true"
      data-minimuminputlength="0"
...
'); ?>
      ...
      data-getrelationurl="'. agents_url('polllist/getAllC4_zone') . '"
      data-placeholder="'. lang('home.all') . '" 
      data-theme="bootstrap4" 
      data-selectonclose="true"
      data-minimuminputlength="0"
...
'); ?>
            ...
            <?=lang('polllist.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=agents_url('polllist/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_polllist" class="table table-hover" width="100%" cellspacing="0" data-url="<?=agents_url('polllist/readPolllist/polllist');?>"></table>
            </div>
...
<script src="<?= agents_url('polllist/langJS');?>"></script>

    <script src="<?= site_url('assets/agents/polllist/polllist.js');?>"></script> 
