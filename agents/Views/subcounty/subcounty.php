...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fas fa-calendar-day"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = agents_url('subcounty/showForm/subcounty');           
...
<?php echo form_open(agents_url('subcounty/readSubcounty/subcounty'), 'id="form_subcounty"'); ?>
      ...
      id="search_countyid"
      data-ajax--url="'. agents_url('subcounty/getAllCounty') . '"
      data-getrelationurl="'. agents_url('subcounty/getAllCounty') . '"
...
'); ?>
            ...
            <?=lang('subcounty.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=agents_url('subcounty/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_subcounty" class="table table-hover" width="100%" cellspacing="0" data-url="<?=agents_url('subcounty/readSubcounty/subcounty');?>"></table>
            </div>
...
<script src="<?= agents_url('subcounty/langJS');?>"></script>

    <script src="<?= site_url('assets/agents/subcounty/subcounty.js');?>"></script> 
