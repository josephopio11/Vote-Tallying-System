...
$url = agents_url('subcounty/save/subcounty');
$hiddenArray = [];
...
<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fas fa-calendar-day"></i> <?=lang('subcounty._form_subcounty'); ?> </h5>
    ...
    <div class="form-row">
        <div class="col">
         ...
         <div class="form-group" id="groupField_countyid">
            <label for="countyid" class="permit_empty col-form-label"> <?=lang('subcounty.countyid'); ?></label>
      ...
      data-required ="permit_empty" id="countyid3256" data-newinputname="new_countyid""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {countyid}"'); ?>
        ...
        <div class="col">
         ...
         <div class="form-group" id="groupField_name">
            <label for="name" class="permit_empty col-form-label"> <?=lang('subcounty.name'); ?></label>
            
                                <div class="input-group">
                        
                        <?php
                        echo form_input("name", $formData['name'] ?? '', '  id="name" class="form-control" permit_empty maxlength="25" ', 'text'); 
                        ?>
