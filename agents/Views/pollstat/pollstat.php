...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fas fa-eye-dropper"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = agents_url('pollstat/showForm/pollstat');           
...
<?php echo form_open(agents_url('pollstat/readPollstat/pollstat'), 'id="form_pollstat"'); ?>
      ...
      id="search_parishid"
      data-ajax--url="'. agents_url('pollstat/getAllParish') . '"
      data-getrelationurl="'. agents_url('pollstat/getAllParish') . '"
...
'); ?>
            ...
            <?=lang('pollstat.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=agents_url('pollstat/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_pollstat" class="table table-hover" width="100%" cellspacing="0" data-url="<?=agents_url('pollstat/readPollstat/pollstat');?>"></table>
            </div>
...
<script src="<?= agents_url('pollstat/langJS');?>"></script>

    <script src="<?= site_url('assets/agents/pollstat/pollstat.js');?>"></script> 
