...
$url = agents_url('pollstat/save/pollstat');
$hiddenArray = [];
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-required ="required" id="parishid7341" data-newinputname="new_parishid""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {id}"    data-tags="true" data-relationformid="parish" 
'); ?>
                        
                                        <div data-createbutton="parishid7341" style="display: none;">        
