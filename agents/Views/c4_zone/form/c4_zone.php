...
$url = agents_url('c4_zone/save/c4_zone');
$hiddenArray = [];
...
<div class="modal-header">
    <h5 class="modal-title" id=""><i class="far fa-hand-pointer"></i> <?=lang('c4_zone._form_c4_zone'); ?> </h5>
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-required ="required" id="c4_country_id5563" data-newinputname="new_c4_country_id""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {c4_country_id}"    data-filter="c4_country_id=219"'); ?>
