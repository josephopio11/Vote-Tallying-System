...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="far fa-hand-pointer"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = agents_url('c4_zone/showForm/c4_zone');           
...
<?php echo form_open(agents_url('c4_zone/readC4_zone/c4_zone'), 'id="form_c4_zone"'); ?>
      ...
      data-ajax--url="'. agents_url('c4_zone/getAllC4_country') . '"
      data-getrelationurl="'. agents_url('c4_zone/getAllC4_country') . '"
...
'); ?>
            ...
            <div class="card border-light card-body mb-0">
                ...
                <div class="btn-group btn-group-sm" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <div class="btn-group btn-group-sm ml-2 delete_link" role="group">
                        ...
                        data-actionurl= "<?=agents_url('c4_zone/delete');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_c4_zone" class="table table-hover" width="100%" cellspacing="0" data-url="<?=agents_url('c4_zone/readC4_zone/c4_zone');?>"></table>
            </div>
...
<script src="<?= agents_url('c4_zone/langJS');?>"></script>

    <script src="<?= site_url('assets/agents/c4_zone/c4_zone.js');?>"></script> 
