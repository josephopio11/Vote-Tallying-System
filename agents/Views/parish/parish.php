...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = agents_url('parish/showForm/parish');           
...
<?php echo form_open(agents_url('parish/readParish/parish'), 'id="form_parish"'); ?>
      ...
      data-getrelationurl="'. agents_url('parish/getAllSubcounty') . '"
...
'); ?>
            ...
            <?=lang('parish.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=agents_url('parish/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_parish" class="table table-hover" width="100%" cellspacing="0" data-url="<?=agents_url('parish/readParish/parish');?>"></table>
            </div>
...
<script src="<?= agents_url('parish/langJS');?>"></script>

    <script src="<?= site_url('assets/agents/parish/parish.js');?>"></script> 
