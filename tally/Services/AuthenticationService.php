...
class AuthenticationService extends BaseService
{
    ...
    public function getCompany()
    {
        ...
        return $authModel->getCompany($this->getCompany_id());
    ...
    public function getAllData()
    {
        ...
        helper(['Tally\\c4_country', 'Tally\\c4_zone']);
        ...
        {
            $return['country_id'] = $company['country_id'];
        }
        ...
        if (isset($company['zone_id']) && !empty($company['zone_id']))
        {
            $return['zone_id'] = $company['zone_id'];
        }
        ...
        if (isset($company['identityNumber']) && !empty($company['identityNumber']))
        {
            $return['identityNumber'] = $company['identityNumber'];
        }

        $return['zipcode'] = '11111'; // Default
        if (isset($company['zipcode']) && !empty($company['zipcode']))
        {
            $return['zipcode'] = $company['zipcode'];
        }
