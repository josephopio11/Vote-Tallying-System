...
class Services extends CoreServices {
    ...
    public static function file($getShared = true) 
    {
        ...
        return new \Tally\Services\FileService();
    }
    ...
    public static function auth($getShared = true) 
    {
        ...
        return new \Tally\Services\AuthenticationService();
    }
    ...
    public static function subscription($getShared = true) 
    {
        ...
        return new \Tally\Services\SubscriptionService();
    }
