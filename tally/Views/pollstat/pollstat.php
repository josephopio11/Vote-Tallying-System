...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = tally_url('pollstat/showForm/pollstat');           
...
<?php echo form_open(tally_url('pollstat/readPollstat/pollstat'), 'id="form_pollstat"'); ?>
      ...
      data-getrelationurl="'. tally_url('pollstat/getAllParish') . '"
...
'); ?>
            ...
            <?=lang('pollstat.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=tally_url('pollstat/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_pollstat" class="table table-hover" width="100%" cellspacing="0" data-url="<?=tally_url('pollstat/readPollstat/pollstat');?>"></table>
            </div>
...
<script src="<?= tally_url('pollstat/langJS');?>"></script>

    <script src="<?= site_url('assets/tally/pollstat/pollstat.js');?>"></script> 
