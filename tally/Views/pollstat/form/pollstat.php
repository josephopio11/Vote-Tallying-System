...
$url = tally_url('pollstat/save/pollstat');
$hiddenArray = [];
...
<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fas fa-eye-dropper"></i> <?=lang('pollstat._form_pollstat'); ?> </h5>
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-ajax--url="'. tally_url('pollstat/getAllParish') . '" 
      ...
      data-required ="required" id="parishid8878" data-newinputname="new_parishid""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {id}"    data-tags="true" data-relationformid="parish" 
'); ?>
                        
                                        <div data-createbutton="parishid8878" style="display: none;">        
                    <a class="btn btn-sm btn-light btn-block" 
                        href="<?=tally_url('parish/showForm/parish');?>"
                            ...
                            data-select2id="parishid8878"
                            data-relationformid="parish"
                            data-formid="pollstat"
                            data-filter=""
        ...
        <div class="col">
         ...
         <div class="form-group" id="groupField_name">
            <label for="name" class="required col-form-label"> <?=lang('pollstat.name'); ?></label>
                        ...
                        <?php
                        echo form_input("name", $formData['name'] ?? '', '  id="name" class="form-control" required maxlength="50" ', 'text'); 
                        ?>
