...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = tally_url('county/showForm/county');           
...
<?php echo form_open(tally_url('county/readCounty/county'), 'id="form_county"'); ?>
            ...
            <?=lang('county.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=tally_url('county/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_county" class="table table-hover" width="100%" cellspacing="0" data-url="<?=tally_url('county/readCounty/county');?>"></table>
            </div>
...
<script src="<?= tally_url('county/langJS');?>"></script>

    <script src="<?= site_url('assets/tally/county/county.js');?>"></script> 
