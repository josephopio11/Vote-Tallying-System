...
$url = tally_url('votes/save/votes');
$hiddenArray = [];
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-ajax--url="'. tally_url('votes/getAllC4_zone') . '" 
      ...
      data-required ="required" id="districtid6022" data-newinputname="new_districtid""
      ...
      data-ajax--url="'. tally_url('votes/getAllCounty') . '" 
      data-placeholder="'. lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-formname="votes"
      ...
      data-required ="required" id="countyid6201" data-newinputname="new_countyid""
      ...
      data-ajax--url="'. tally_url('votes/getAllSubcounty') . '" 
      data-placeholder="'. lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-formname="votes"
      data-rprimarykey="id" data-getrelationurl="votes/getAllSubcounty"
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="subcountyid8534" data-newinputname="new_subcountyid""
      ...
      data-ajax--url="'. tally_url('votes/getAllParish') . '" 
      data-placeholder="'. lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-formname="votes"
      data-rprimarykey="id" data-getrelationurl="votes/getAllParish"
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="parishid8823" data-newinputname="new_parishid""
...
'); ?>
                                        ...
                                        <div data-createbutton="parishid8823" style="display: none;">        
                    <a class="btn btn-sm btn-light btn-block" 
                        href="<?=tally_url('parish/showForm/parish');?>"
                            data-modalsize="lg"
                            data-modalurl="<?=tally_url('parish/showForm/parish');?>"
                            data-modaldata=""
                            data-modalview="centermodal" 
                            data-modalbackdrop="true"
                            data-select2id="parishid8823"
    ...
    <div class="form-row">
      ...
      data-ajax--url="'. tally_url('votes/getAllPollstat') . '" 
      data-placeholder="'. lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-formname="votes"
      data-rprimarykey="id" data-getrelationurl="votes/getAllPollstat"
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="pollstatid6696" data-newinputname="new_pollstatid""
...
'); ?>
                                        ...
                                        <div data-createbutton="pollstatid6696" style="display: none;">        
                    <a class="btn btn-sm btn-light btn-block" 
                        href="<?=tally_url('pollstat/showForm/pollstat');?>"
                            data-modalsize="lg"
                            data-modalurl="<?=tally_url('pollstat/showForm/pollstat');?>"
                            data-modaldata=""
                            data-modalview="centermodal" 
                            data-modalbackdrop="true"
                            data-select2id="pollstatid6696"
...
<div class="input-group">
    ...
    {
        $fileService = \Tally\Config\Services::file();
    ...
    <label class="label labelcropper" data-toggle="tooltip" title="<?=lang("votes.evidence_helpText")?>" style="cursor: pointer;">
        ...
        <input type="file" name="file" accept="image/*" class="sr-only cropperjs" id="input_<?=$randomID;?>" 
            data-action="<?=tally_url("votes/uploadFile/votes/evidence");?>" data-inputname="evidence" data-idnumber="<?=$randomID;?>" 
