...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = tally_url('votes/showForm/votes');           
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-danger o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= tally_url('votes/readStatistic/votes/Olemukan-Moses');?>" 
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-warning o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= tally_url('votes/readStatistic/votes/Tukei-William-Wilberforce');?>" 
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-success o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= tally_url('votes/readStatistic/votes/Osekeny-Sam');?>" 
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-primary o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= tally_url('votes/readStatistic/votes/Omagor-Sam-Okoche');?>" 
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-dark o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= tally_url('votes/readStatistic/votes/Total-Invalid');?>" 
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-dark o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= tally_url('votes/readStatistic/votes/Total-Not-Voted');?>" 
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-dark o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= tally_url('votes/readStatistic/votes/Polling-Stations-Recorded');?>" 
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-white bg-dark o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= tally_url('votes/readStatistic/votes/Total-Voters');?>" 
...
<?php echo form_open(tally_url('votes/readVotes/votes'), 'id="form_votes"'); ?>
            ...
            <?=lang('votes.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=tally_url('votes/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_votes" class="table table-hover" width="100%" cellspacing="0" data-url="<?=tally_url('votes/readVotes/votes');?>"></table>
            </div>
...
<script src="<?= tally_url('votes/langJS');?>"></script>

    <script src="<?= site_url('assets/tally/votes/votes.js');?>"></script> 
