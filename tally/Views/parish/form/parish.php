...
$url = tally_url('parish/save/parish');
$hiddenArray = [];
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-required ="required" id="subcountyid5808" data-newinputname="new_subcountyid""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {id}"    data-tags="true" data-relationformid="subcounty" 
'); ?>
                        
                                        <div data-createbutton="subcountyid5808" style="display: none;">        
                    <a class="btn btn-sm btn-light btn-block" 
                        href="<?=tally_url('subcounty/showForm/subcounty');?>"
                            data-modalsize="lg"
                            data-modalurl="<?=tally_url('subcounty/showForm/subcounty');?>"
                            data-modaldata=""
                            data-modalview="centermodal" 
                            data-modalbackdrop="true"
                            data-select2id="subcountyid5808"
