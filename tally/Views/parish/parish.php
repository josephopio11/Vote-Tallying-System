...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fas fa-dolly-flatbed"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = tally_url('parish/showForm/parish');           
...
<?php echo form_open(tally_url('parish/readParish/parish'), 'id="form_parish"'); ?>
      ...
      data-ajax--url="'. tally_url('parish/getAllSubcounty') . '"
      data-getrelationurl="'. tally_url('parish/getAllSubcounty') . '"
...
'); ?>
            ...
            <?=lang('parish.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=tally_url('parish/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_parish" class="table table-hover" width="100%" cellspacing="0" data-url="<?=tally_url('parish/readParish/parish');?>"></table>
            </div>
...
<script src="<?= tally_url('parish/langJS');?>"></script>

    <script src="<?= site_url('assets/tally/parish/parish.js');?>"></script> 
