...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = tally_url('subcounty/showForm/subcounty');           
...
<?php echo form_open(tally_url('subcounty/readSubcounty/subcounty'), 'id="form_subcounty"'); ?>
      ...
      id="search_countyid"
      data-ajax--url="'. tally_url('subcounty/getAllCounty') . '"
      data-getrelationurl="'. tally_url('subcounty/getAllCounty') . '"
...
'); ?>
            ...
            <?=lang('subcounty.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=tally_url('subcounty/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_subcounty" class="table table-hover" width="100%" cellspacing="0" data-url="<?=tally_url('subcounty/readSubcounty/subcounty');?>"></table>
            </div>
...
<script src="<?= tally_url('subcounty/langJS');?>"></script>

    <script src="<?= site_url('assets/tally/subcounty/subcounty.js');?>"></script> 
