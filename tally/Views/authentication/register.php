...
<div class="container">
    ...
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">            
            ...
            <?php echo form_open(tally_url('auth/register'), ' class="crud4form needs-validation form-signin" id="register" data-packagelist="selectpicker,dropzone,select2_js"'); ?>            
      ...
      data-ajax--url="' . tally_url('general/getAllC4_country') . '" 
      ...
      data-ajax--url="' . tally_url('general/getAllC4_zone') . '" 
      data-placeholder="' . lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-tags="false" data-formname="register"
      ...
      data-required ="required" id="c4_zone_id" data-newinputname="new_zone_id" data-filter="c4_country_id"'); 
        ?>
            ...
            <div class="form-group">
                <a href="<?=tally_url('general/userAgreement');?>" target="_blank"></a>
            </div>
            <div class="form-group">
                <div class="checkbox">
                    <label>
            ...
            <div class="text-center d-block small pb-2">
                         <?= lang('auth.askAccountToLogin'); ?> <a class="" href="<?= tally_url('auth/login'); ?>"><?= lang('auth.login'); ?></a>
            </div>
            <hr/>
            
            <div class="text-center d-block small">
                    <a href="<?=tally_url('general/termsOfService');?>" target="_blank"><?= lang('auth.agreementIfContinue'); ?></a>
            </div>
