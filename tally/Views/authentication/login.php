...
<div class="container">
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
            ...
            <?= form_open(tally_url('auth/login'), ' class="needs-validation form-signin crud4form" id="loginForm" data-packagelist=""'); ?>
        ...
        <div class="card-footer text-center">
             <a class="d-block small" href="<?=tally_url('auth/forgot');?>"><?= lang('auth.askResetPassword'); ?></a>
            
                <hr/>

                <div class="text-center pb-1">
                    <a class="d-block small" href="<?=tally_url('auth/register');?>"><?= lang('auth.askNewAccount'); ?></a>
                </div>
