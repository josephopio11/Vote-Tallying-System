...
<div class="container">
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
            ...
            <?php echo form_open(tally_url('auth/forgot'), ' class="crud4form needs-validation form-signin" id="forgotForm" data-packagelist=""'); ?>
        ...
        <div class="card-footer text-center">
            <a class="d-block small" href="<?= tally_url('auth'); ?>"><?= lang('auth.loginPage'); ?></a>
        </div>
    </div>
</div>
