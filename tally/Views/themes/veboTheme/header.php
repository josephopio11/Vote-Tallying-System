...
<body id="page-top" class="sidebar-toggled">
    ...
    <nav class="navbartop navbar navbar-expand  navbar-header static-top shadow-sm bg-white rounded">
        ...
        <a class="navbar-brand p-1 mr-1 text-center toggled" href="<?=tally_url('home/index');?>">
...
<?php endif; ?>
        ...
        <ul class="navbar-nav ml-auto ml-md-0">
                ...
                <li class="nav-item dropdown no-arrow mx-1 d-none d-sm-block">
                    ...
                    <a class="nav-link dropdown-toggle" href="<?= $subscriptionService->getPage(); ?>"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="text-muted"><?= $subscriptionService->getRemainingString(); ?></span>                  
                    </a>

                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="messagesDropdown">
                        <a class="dropdown-item" href="<?= $subscriptionService->getPage(); ?>"><i class="fas fa-user-circle fa-fw"></i> <?= lang('subscribe.subscribe'); ?></a>
                    </div>
                </li>
            <li class="nav-item dropdown no-arrow mx-1">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <div class="card border-light mb-2" style="width: 18rem;">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-9">
                                    <div class="card-body p-1 m-1">
                                        <h5 class="card-title"><?= $authService->getFullName(); ?></h5>
                                        <p class="card-text"><?= $authService->getEmail(); ?> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <a class="dropdown-item" href="<?=tally_url('home/account/personel');?>"><?=lang('home.account');?></a>
                        <a class="dropdown-item" href="<?=tally_url('auth/logout');?>" data-toggle="modal" data-target="#logoutModal"><?=lang('home.logout');?></a>
                    </div>
                </li>
...
<?php echo tally_view('themes/veboTheme/menu-part'); ?>
    </ul>
    <!-- / Sidebar -->
