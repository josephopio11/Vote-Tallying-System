...
class CountyModel extends Model
{
    ...
    protected $allowedFields  = ["countyid","name","zoneid","status","created_at","updated_at","deleted_at"];
    ...
    protected function beforeInsert(array $data)
    {
        ...
        {
            return county_beforeInsert($data);
        }
    ...
    protected function beforeUpdate(array $data)
    {
        ...
        {
            return county_beforeUpdate($data);
        }
    ...
    protected function beforeDelete(array $data)
    {
        ...
        {
            return county_beforeDelete($data);
        }
    ...
    {
        if (function_exists('county_afterFind'))
        {
            return county_afterFind($data);
        }
