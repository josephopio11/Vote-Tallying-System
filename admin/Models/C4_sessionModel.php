...
class C4_sessionModel extends Model
{

    //--------------------------------------------------------------------

    protected $table          = 'c4_session';
    ...
    protected function beforeInsert(array $data)
    {
        ...
        {
            return c4_session_beforeInsert($data);
        }
    ...
    protected function beforeUpdate(array $data)
    {
        ...
        {
            return c4_session_beforeUpdate($data);
        }
    ...
    protected function beforeDelete(array $data)
    {
        ...
        {
            return c4_session_beforeDelete($data);
        }
    ...
    {
        if (function_exists('c4_session_afterFind'))
        {
            return c4_session_afterFind($data);
        }
