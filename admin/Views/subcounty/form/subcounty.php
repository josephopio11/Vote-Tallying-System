...
$url = admin_url('subcounty/save/subcounty');
$hiddenArray = [];
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-required ="required" id="countyid8153" data-newinputname="new_countyid""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {countyid}"    data-tags="true" data-relationformid="county" 
'); ?>
                        
                                        <div data-createbutton="countyid8153" style="display: none;">        
                    <a class="btn btn-sm btn-light btn-block" 
                        href="<?=admin_url('county/showForm/county');?>"
                            data-modalsize="lg"
                            data-modalurl="<?=admin_url('county/showForm/county');?>"
                            data-modaldata=""
                            data-modalview="centermodal" 
                            data-modalbackdrop="true"
                            data-select2id="countyid8153"
                            data-relationformid="county"
                            data-formid="subcounty"
                            data-filter=""
