...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = admin_url('parish/showForm/parish');           
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 mt-1 mb-1">
            <div class="card text-dark bg-white o-hidden h-100" data-viewplace="onpage" 
                data-action="readStatistic" data-type="number" data-ajaxurl="<?= admin_url('parish/readStatistic/parish/Parishes');?>" 
...
<?php echo form_open(admin_url('parish/readParish/parish'), 'id="form_parish"'); ?>
      ...
      data-getrelationurl="'. admin_url('parish/getAllSubcounty') . '"
...
'); ?>
            ...
            <?=lang('parish.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=admin_url('parish/update');?>"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_parish" class="table table-hover" width="100%" cellspacing="0" data-url="<?=admin_url('parish/readParish/parish');?>"></table>
            </div>
...
<script src="<?= admin_url('parish/langJS');?>"></script>

    <script src="<?= site_url('assets/admin/parish/parish.js');?>"></script> 
