<?php
$tableTitle = lang('c4_sms_history._page_c4_sms_history');
?>
...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fas fa-phone"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = admin_url('c4_sms_history/showForm/c4_sms_history');           
            ...
            ?>
                            ...
                            <a class="nav-link  btn btn-sm btn-primary mr-1" 
                               ...
                               data-action="openformmodal">
                                <span>
                                    ...
                                    <span><?=lang('c4_sms_history._form_c4_sms_history'); ?></span>
                                </span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-primary mr-1 dropdown-toggle" data-toggle="collapse" href="#searchFormArea_c4_sms_history" aria-controls="searchFormArea_c4_sms_history" aria-expanded="false">
    ...
    <div class="card-body mb-0 pt-0">
        ...
        <!--begin: Search Form -->
        <div class="collapse p-1" id="searchFormArea_c4_sms_history">
            <div class="card card-body border-light p-0">

<?php echo form_open(admin_url('c4_sms_history/readC4_sms_history/c4_sms_history'), 'id="form_c4_sms_history"'); ?>
                ...
                <div class="form-row">
                                ...
                                <div class="form-group col-md-2 col-sm-6">
                                    <label><?=lang('c4_sms_history.is_sended'); ?></label>
                                                
                                    <?php
                                    $option_list = lang('c4_sms_history.list_is_sended');
                                    ?>                                       
                                    <?php
        ...
        <div class="collapse batchProcessing" id="batch_c4_sms_history">
            ...
            <div class="card border-light card-body mb-0">
                ...
                <div class="btn-group btn-group-sm" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <div class="btn-group btn-group-sm ml-2 delete_link" role="group">
                        ...
                        data-actionurl= "<?=admin_url('c4_sms_history/update');?>"
                        data-datatable="table_c4_sms_history"  data-jsname="c4_sms_history"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_c4_sms_history" class="table table-hover" width="100%" cellspacing="0" data-url="<?=admin_url('c4_sms_history/readC4_sms_history/c4_sms_history');?>"></table>
            </div>
...
<script src="<?= admin_url('c4_sms_history/langJS');?>"></script>

    <script src="<?= site_url('assets/admin/c4_sms_history/c4_sms_history.js');?>"></script> 
