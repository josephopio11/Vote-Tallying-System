...
$url = admin_url('votes/save/votes');
$hiddenArray = [];
...
<div class="modal-body">
    ...
    <div class="form-row">
      ...
      data-ajax--url="'. admin_url('votes/getAllC4_zone') . '" 
      ...
      data-required ="required" id="districtid2781" data-newinputname="new_districtid""
      ...
      data-ajax--url="'. admin_url('votes/getAllCounty') . '" 
      data-placeholder="'. lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-formname="votes"
      ...
      data-required ="required" id="countyid4577" data-newinputname="new_countyid""
      ...
      data-ajax--url="'. admin_url('votes/getAllSubcounty') . '" 
      data-placeholder="'. lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-formname="votes"
      data-rprimarykey="id" data-getrelationurl="votes/getAllSubcounty"
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="subcountyid9456" data-newinputname="new_subcountyid""
      ...
      data-ajax--url="'. admin_url('votes/getAllParish') . '" 
      data-placeholder="'. lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-formname="votes"
      data-rprimarykey="id" data-getrelationurl="votes/getAllParish"
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="parishid2962" data-newinputname="new_parishid""
...
'); ?>
                                        ...
                                        <div data-createbutton="parishid2962" style="display: none;">        
                    <a class="btn btn-sm btn-light btn-block" 
                        href="<?=admin_url('parish/showForm/parish');?>"
                            data-modalsize="lg"
                            data-modalurl="<?=admin_url('parish/showForm/parish');?>"
                            data-modaldata=""
                            data-modalview="centermodal" 
                            data-modalbackdrop="true"
                            data-select2id="parishid2962"
    ...
    <div class="form-row">
      ...
      data-ajax--url="'. admin_url('votes/getAllPollstat') . '" 
      data-placeholder="'. lang('home.select') . '" data-theme="bootstrap4" data-selectonclose="true"
      data-minimuminputlength="0" data-formname="votes"
      data-rprimarykey="id" data-getrelationurl="votes/getAllPollstat"
      data-rkeyfield="id" data-rvaluefield="name" data-rvaluefield2=""
      data-required ="required" id="pollstatid7563" data-newinputname="new_pollstatid""
...
'); ?>
                                        ...
                                        <div data-createbutton="pollstatid7563" style="display: none;">        
                    <a class="btn btn-sm btn-light btn-block" 
                        href="<?=admin_url('pollstat/showForm/pollstat');?>"
                            data-modalsize="lg"
                            data-modalurl="<?=admin_url('pollstat/showForm/pollstat');?>"
                            data-modaldata=""
                            data-modalview="centermodal" 
                            data-modalbackdrop="true"
                            data-select2id="pollstatid7563"
...
<div class="input-group">
    ...
    <label class="label labelcropper" data-toggle="tooltip" title="<?=lang("votes.evidence_helpText")?>" style="cursor: pointer;">
        ...
        <input type="file" name="file" accept="image/*" class="sr-only cropperjs" id="input_<?=$randomID;?>" 
            data-action="<?=admin_url("votes/uploadFile/votes/evidence");?>" data-inputname="evidence" data-idnumber="<?=$randomID;?>" 
