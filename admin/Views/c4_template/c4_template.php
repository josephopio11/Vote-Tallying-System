<?php
$tableTitle = lang('c4_template._page_c4_template');
?>
...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fas fa-gopuram"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = admin_url('c4_template/showForm/c4_template');           
            ...
            ?>
                            ...
                            <a class="nav-link  btn btn-sm btn-primary mr-1" 
                               ...
                               data-action="openformmodal">
                                <span>
                                    ...
                                    <span><?=lang('c4_template._form_c4_template'); ?></span>
                                </span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-primary mr-1 dropdown-toggle" data-toggle="collapse" href="#searchFormArea_c4_template" aria-controls="searchFormArea_c4_template" aria-expanded="false">
    ...
    <div class="card-body mb-0 pt-0">
        ...
        <!--begin: Search Form -->
        <div class="collapse p-1" id="searchFormArea_c4_template">
            <div class="card card-body border-light p-0">

<?php echo form_open(admin_url('c4_template/readC4_template/c4_template'), 'id="form_c4_template"'); ?>
                ...
                <div class="form-row">
                        ...
                        <?php $searchText = lang("c4_template.name"); ?>
        ...
        <div class="collapse batchProcessing" id="batch_c4_template">
            ...
            <?=lang('c4_template.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=admin_url('c4_template/update');?>"
                                               data-datatable="table_c4_template" data-jsname="c4_template"
                                               data-question="<?=lang("home.areyousure");?>"
                                               data-subtitle="<b><?=lang("c4_template.status");?></b> <?=lang("home.will_be_updated");?> "
                                               data-processingtitle="<?=lang("home.processing");?>" 
                                               data-postdata='{"status":"1"}'><?=lang('c4_template.list_status')['1'] ?? '1'; ?></a>
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-subtitle="<b><?=lang("c4_template.status");?></b> <?=lang("home.will_be_updated");?> "
                                               data-processingtitle="<?=lang("home.processing");?>" 
                                               data-postdata='{"status":"2"}'><?=lang('c4_template.list_status')['2'] ?? '2'; ?></a>
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_c4_template" class="table table-hover" width="100%" cellspacing="0" data-url="<?=admin_url('c4_template/readC4_template/c4_template');?>"></table>
            </div>
...
<script src="<?= admin_url('c4_template/langJS');?>"></script>

    <script src="<?= site_url('assets/admin/c4_template/c4_template.js');?>"></script> 
