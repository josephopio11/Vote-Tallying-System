<?php
$tableTitle = lang('company._page_company');
?>
...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fas fa-building"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = admin_url('company/showForm/company');           
            ...
            ?>
                            ...
                            <a class="nav-link  btn btn-sm btn-primary mr-1" 
                               ...
                               data-action="openformmodal">
                                <span>
                                    ...
                                    <span><?=lang('company._form_company'); ?></span>
                                </span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-primary mr-1 dropdown-toggle" data-toggle="collapse" href="#searchFormArea_company" aria-controls="searchFormArea_company" aria-expanded="false">
    ...
    <div class="card-body mb-0 pt-0">
        ...
        <!--begin: Search Form -->
        <div class="collapse p-1" id="searchFormArea_company">
            <div class="card card-body border-light p-0">

<?php echo form_open(admin_url('company/readCompany/company'), 'id="form_company"'); ?>
                ...
                <div class="form-row">
                        ...
                        <?php $searchText = lang("company.name"); ?>
        ...
        <div class="collapse batchProcessing" id="batch_company">
            ...
            <?=lang('company.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=admin_url('company/update');?>"
                                               data-datatable="table_company" data-jsname="company"
                                               data-question="<?=lang("home.areyousure");?>"
                                               data-subtitle="<b><?=lang("company.status");?></b> <?=lang("home.will_be_updated");?> "
                                               data-processingtitle="<?=lang("home.processing");?>" 
                                               data-postdata='{"status":"1"}'><?=lang('company.list_status')['1'] ?? '1'; ?></a>
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-subtitle="<b><?=lang("company.status");?></b> <?=lang("home.will_be_updated");?> "
                                               data-processingtitle="<?=lang("home.processing");?>" 
                                               data-postdata='{"status":"2"}'><?=lang('company.list_status')['2'] ?? '2'; ?></a>
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_company" class="table table-hover" width="100%" cellspacing="0" data-url="<?=admin_url('company/readCompany/company');?>"></table>
            </div>
...
<script src="<?= admin_url('company/langJS');?>"></script>

    <script src="<?= site_url('assets/admin/company/company.js');?>"></script> 
