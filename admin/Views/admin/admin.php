<?php
$tableTitle = lang('admin._page_admin');
?>
...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = admin_url('admin/showForm/admin');           
                            ...
                            <a class="nav-link  btn btn-sm btn-primary mr-1" 
                               ...
                               data-action="openformmodal">
                                <span>
                                    ...
                                    <span><?=lang('admin._form_admin'); ?></span>
                                </span>
                            </a>
                        </li>
...
<?php echo form_open(admin_url('admin/readAdmin/admin'), 'id="form_admin"'); ?>
        ...
        <div class="collapse batchProcessing" id="batch_admin">
            ...
            <?=lang('admin.status'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-actionurl= "<?=admin_url('admin/update');?>"
                                               data-datatable="table_admin" data-jsname="admin"
                                               data-question="<?=lang("home.areyousure");?>"
                                               data-subtitle="<b><?=lang("admin.status");?></b> <?=lang("home.will_be_updated");?> "
                                               data-processingtitle="<?=lang("home.processing");?>" 
                                               data-postdata='{"status":"1"}'><?=lang('admin.list_status')['1'] ?? '1'; ?></a>
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-subtitle="<b><?=lang("admin.status");?></b> <?=lang("home.will_be_updated");?> "
                                               data-processingtitle="<?=lang("home.processing");?>" 
                                               data-postdata='{"status":"2"}'><?=lang('admin.list_status')['2'] ?? '2'; ?></a>
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_admin" class="table table-hover" width="100%" cellspacing="0" data-url="<?=admin_url('admin/readAdmin/admin');?>"></table>
            </div>
...
<script src="<?= admin_url('admin/langJS');?>"></script>

    <script src="<?= site_url('assets/admin/admin/admin.js');?>"></script> 
