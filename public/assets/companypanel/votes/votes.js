...
var votes = function () {
    ...
    var tableID = 'table_votes';
    var page_slug = 'votes';
    var tableUrlExt = ''; //Datatabel Url Extension
    var form_sizes = {"votes":"lg"};
    ...
    var init_datatable = function () {
        ...
        DT1 = $('#' + tableID).DataTable({
            ...
            "ajax": {
                ...
                "type": 'POST',
                "data": function (d) {
                    d.formFilter = $('#form_votes').serialize();
            ...
            columns: [
                {
                    "searchable": false,
                    "targets": 0,
                    title: '<label for="votesselectAll" class="text-center" style="width: 100%"><div class="text-center"><input type="checkbox" class="selectAll" id="votesselectAll"/></div></label>',
                    defaultContent: '',
                    "data": null,
                    orderable: false,
                    className: 'select-checkbox',
            ...
            {   
                ...
                data: function ( row, type, set, meta ) {
                    ...
                    var text = escapeHtml(row.evidence);
            ...
            {   
                ...
                data: function ( row, type, set, meta ) {
                    ...
                    var text = escapeHtml(row.userid);
        ...
        //Form
        $('#form_votes').find('.generalSearch').bind("keyup search", function () {
            console.log('Searching..');
            DT1.ajax.reload();
        });

        $('#form_votes').find('.formSearch').on('change', function (e) {
