...
var usertype = function () {
    ...
    var tableID = 'table_usertype';
    var page_slug = 'usertype';
    var tableUrlExt = ''; //Datatabel Url Extension
    var form_sizes = {"usertype":"lg"};
    ...
    var get_url = function (param) {
        ...
        return panel_url('usertype' + param);
    ...
    //Module Lang
    var usertypeLang = function (param, paramsub) {
        return getLang('usertype', param, paramsub);
    };  
    ...
    var init_datatable = function () {
        ...
        DT1 = $('#' + tableID).DataTable({
            ...
            "ajax": {
                ...
                "type": 'POST',
                "data": function (d) {
                    d.formFilter = $('#form_usertype').serialize();
            ...
            columns: [
                {
                    "searchable": false,
                    "targets": 0,
                    title: '<label for="usertypeselectAll" class="text-center" style="width: 100%"><div class="text-center"><input type="checkbox" class="selectAll" id="usertypeselectAll"/></div></label>',
                    defaultContent: '',
                    "data": null,
                    orderable: false,
                    className: 'select-checkbox',
            ...
            {   
                ...
                name: 'usertype',
                title: usertypeLang('usertype'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.usertype !== 'string'){
                        return '';
                    }
                                        
                    var text = escapeHtml(row.usertype);
            ...
            {   
                ...
                data: function ( row, type, set, meta ) {
                    ...
                    var text = escapeHtml(row.comment);
            ...
            },
                    {
                        ...
                        data: function (row) {
                            ...
                            //usertype form button
                            
                            $link += `<a
                               href="` + get_url('showForm/usertype/' + id) + `" 
                               data-modalsize="lg"
                               data-datatable="table_usertype"
                               data-modalurl="` + get_url('showForm/usertype/' + id) + `"
                               data-modaldata='{"type_id":"` + id + `"}'
                               data-action="openformmodal"
                               data-modalview="centermodal"
                               data-modalbackdrop="true"
                               class="btn btn-sm btn-primary"
                               title="` + usertypeLang('_form_usertype') + `" 
            ...
            "rowCallback": function (row, data) {
                ...
                .on('draw', function () {
                    ...
                    var $selectAll = $('#usertypeselectAll');
        ...
        //Form
        $('#form_usertype').find('.generalSearch').bind("keyup search", function () {
            console.log('Searching..');
            DT1.ajax.reload();
        });

        $('#form_usertype').find('.formSearch').on('change', function (e) {
    ...
    return {
        ...
        returnLang: function (param, paramsub) {
            return usertypeLang(param, paramsub);
        },
