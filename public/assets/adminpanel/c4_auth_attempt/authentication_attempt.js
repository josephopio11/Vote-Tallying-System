...
var authentication_attempt = function () {

    var tableID = 'table_authentication_attempt';
    var page_slug = 'authentication_attempt';
    var tableUrlExt = ''; //Datatabel Url Extension
    var form_sizes = {"c4_auth_attempt":"lg"};
    ...
    var get_url = function (param) {
        ...
        return panel_url('c4_auth_attempt' + param);
    ...
    //Module Lang
    var c4_auth_attemptLang = function (param, paramsub) {
        return getLang('c4_auth_attempt', param, paramsub);
    };  
    ...
    var init_datatable = function () {
        ...
        DT1 = $('#' + tableID).DataTable({
            ...
            "ajax": {
                ...
                "type": 'POST',
                "data": function (d) {
                    d.formFilter = $('#form_authentication_attempt').serialize();
            ...
            columns: [
                {
                    "searchable": false,
                    "targets": 0,
                    title: '<label for="authentication_attemptselectAll" class="text-center" style="width: 100%"><div class="text-center"><input type="checkbox" class="selectAll" id="authentication_attemptselectAll"/></div></label>',
                    defaultContent: '',
                    "data": null,
                    orderable: false,
                    className: 'select-checkbox',
            ...
            {   
                ...
                name: 'ip_address',
                title: c4_auth_attemptLang('ip_address'),
            ...
            {   
                sortable : true,
                name: 'email',
                title: c4_auth_attemptLang('email'),
                data: function ( row, type, set, meta ) {
            ...
            {   
                ...
                name: 'table',
                title: c4_auth_attemptLang('table'),
                data: function ( row, type, set, meta ) {
            ...
            {   
                ...
                name: 'whoisID',
                title: c4_auth_attemptLang('whoisID'),
                data: function ( row, type, set, meta ) {
            ...
            {   
                ...
                name: 'attemp_type',
                title: c4_auth_attemptLang('attemp_type'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.attemp_type !== 'string'){
                        return '';
                    }
                                        
                    var text = escapeHtml(row.attemp_type);
            ...
            {   
                ...
                name: 'success',
                title: c4_auth_attemptLang('success'),
                className: "text-center",
                data: function ( row, type, set, meta ) {
                
                    var data_list = c4_auth_attemptLang('list_success');
               
                                    
                
                if(row.success == '1'){
                      return '<span class="badge badge-danger">' + data_list[row.success] + '</span>';
                }
                else if(row.success == '0' || row.success == '2'){
                      return '<span class="badge badge-success">' + data_list[row.success] + '</span>';
                }

                return !isEmpty(row.success)? escapeHtml(data_list[row.success]) : '';
            ...
            {   
                ...
                name: 'message',
                title: c4_auth_attemptLang('message'),
                data: function ( row, type, set, meta ) {
            ...
            {   
                ...
                name: 'userAgent',
                title: c4_auth_attemptLang('userAgent'),
                data: function ( row, type, set, meta ) {
            ...
            },
                    {
                        ...
                        data: function (row) {
                            var id = row.c4_auth_attempt_id;
                            var $link = ``;

                                var $link =`<div class="btn-group" role="group" aria-label="">`;
        
                            //c4_auth_attempt form button
                            
                            $link += `<a
                               href="` + get_url('showForm/c4_auth_attempt/' + id) + `" 
                               data-modalsize="lg"
                               data-datatable="table_authentication_attempt"
                               data-modalurl="` + get_url('showForm/c4_auth_attempt/' + id) + `"
                               data-modaldata='{"c4_auth_attempt_id":"` + id + `"}'
                               data-action="openformmodal"
                               data-modalview="centermodal"
                               data-modalbackdrop="true"
                               class="btn btn-sm btn-primary"
                               title="` + c4_auth_attemptLang('_form_c4_auth_attempt') + `" 
            ...
            "rowCallback": function (row, data) {
                ...
                .on('select', function (e, dt, type, indexes) {
                    ...
                    $('#batch_authentication_attempt').collapse('show');
                    if (type === 'row') {
                ...
                .on('deselect', function (e, dt, type, indexes) {
                    ...
                    if (type === 'row') {
                        ...
                        if (count === 0) {
                            $('#batch_authentication_attempt').collapse('hide');
                        }
                ...
                .on('draw', function () {
                    ...
                    var $selectAll = $('#authentication_attemptselectAll');
        ...
        //Form
        $('#form_authentication_attempt').find('.generalSearch').bind("keyup search", function () {
            console.log('Searching..');
            DT1.ajax.reload();
        });

        $('#form_authentication_attempt').find('.formSearch').on('change', function (e) {
    ...
    return {
        ...
        returnLang: function (param, paramsub) {
            return c4_auth_attemptLang(param, paramsub);
        },
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if ($('#table_authentication_attempt').length > 0) {
    
        general.loadPackage('dataTable', function () {
            loadDatatableLang(function () {
                authentication_attempt.init_datatable();
            });
        });
