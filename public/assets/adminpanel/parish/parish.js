...
var parish = function () {
    ...
    var tableID = 'table_parish';
    var page_slug = 'parish';
    var tableUrlExt = ''; //Datatabel Url Extension
    var form_sizes = {"parish":"lg"};
    ...
    //Module Lang
    var parishLang = function (param, paramsub) {
        return getLang('parish', param, paramsub);
    };  
    ...
    var init_datatable = function () {
        ...
        DT1 = $('#' + tableID).DataTable({
            ...
            "ajax": {
                ...
                "type": 'POST',
                "data": function (d) {
                    d.formFilter = $('#form_parish').serialize();
            ...
            columns: [
                {
                    "searchable": false,
                    "targets": 0,
                    title: '<label for="parishselectAll" class="text-center" style="width: 100%"><div class="text-center"><input type="checkbox" class="selectAll" id="parishselectAll"/></div></label>',
                    defaultContent: '',
                    "data": null,
                    orderable: false,
                    className: 'select-checkbox',
        ...
        //Form
        $('#form_parish').find('.generalSearch').bind("keyup search", function () {
            console.log('Searching..');
            DT1.ajax.reload();
        });

        $('#form_parish').find('.formSearch').on('change', function (e) {
    ...
    return {
        ...
        returnLang: function (param, paramsub) {
            return parishLang(param, paramsub);
        },
