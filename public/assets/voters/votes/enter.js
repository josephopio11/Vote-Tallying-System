...
var enter = function () {
    ...
    var tableID = 'table_enter';
    var page_slug = 'enter';
    var tableUrlExt = ''; //Datatabel Url Extension
    var form_sizes = {"enter":"lg"};
    ...
    var init_datatable = function () {
        ...
        DT1 = $('#' + tableID).DataTable({
            ...
            "ajax": {
                ...
                "type": 'POST',
                "data": function (d) {
                    d.formFilter = $('#form_enter').serialize();
            ...
            columns: [
                {
                    "searchable": false,
                    "targets": 0,
                    title: '<label for="enterselectAll" class="text-center" style="width: 100%"><div class="text-center"><input type="checkbox" class="selectAll" id="enterselectAll"/></div></label>',
                    defaultContent: '',
                    "data": null,
                    orderable: false,
                    className: 'select-checkbox',
        ...
        //Form
        $('#form_enter').find('.generalSearch').bind("keyup search", function () {
            console.log('Searching..');
            DT1.ajax.reload();
        });

        $('#form_enter').find('.formSearch').on('change', function (e) {
