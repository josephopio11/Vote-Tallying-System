...
var results = function () {
    ...
    var tableID = 'table_results';
    var page_slug = 'results';
    var tableUrlExt = ''; //Datatabel Url Extension
    var form_sizes = {"votes62729055":"lg"};
    ...
    var init_datatable = function () {
        ...
        DT1 = $('#' + tableID).DataTable({
            ...
            "ajax": {
                ...
                "type": 'POST',
                "data": function (d) {
                    d.formFilter = $('#form_results').serialize();
            ...
            columns: [
                {
                    "searchable": false,
                    "targets": 0,
                    title: '<label for="resultsselectAll" class="text-center" style="width: 100%"><div class="text-center"><input type="checkbox" class="selectAll" id="resultsselectAll"/></div></label>',
                    defaultContent: '',
                    "data": null,
                    orderable: false,
                    className: 'select-checkbox',
                ...
                data: function ( row, type, set, meta ) 
                {
                    ...
                    return '';
                        ...
                        data: function (row) {
                            ...
                            $link += `<a
                               href="` + get_url('createPdf/votes62729055/' + id) + `"
                               target="_blank"
                               class="dropdown-item btn btn-sm btn-danger" 
                               title="` + votesLang('pdf') + `" 
                               > <i class="fas fa-file-pdf"></i>  ` +votesLang('_form_votes62729055') + ' ' +  votesLang('pdf') + `
                            </a>`;           
            ...
            "rowCallback": function (row, data) {
                ...
                .on('draw', function () {
                    ...
                    var $selectAll = $('#resultsselectAll');
        ...
        $('#form_results').find('.formSearch').on('change', function (e) {
