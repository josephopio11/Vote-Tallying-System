...
var c4_template = function () {

    var tableID = 'table_c4_template';
    var page_slug = 'c4_template';
    var tableUrlExt = ''; //Datatabel Url Extension
    var form_sizes = {"c4_template":"lg"};
    ...
    var get_url = function (param) {
        ...
        return panel_url('c4_template' + param);
    ...
    //Module Lang
    var c4_templateLang = function (param, paramsub) {
        return getLang('c4_template', param, paramsub);
    };  
    ...
    var init_datatable = function () {
        ...
        DT1 = $('#' + tableID).DataTable({
            ...
            "ajax": {
                ...
                "type": 'POST',
                "data": function (d) {
                    d.formFilter = $('#form_c4_template').serialize();
            ...
            columns: [
                {
                    "searchable": false,
                    "targets": 0,
                    title: '<label for="c4_templateselectAll" class="text-center" style="width: 100%"><div class="text-center"><input type="checkbox" class="selectAll" id="c4_templateselectAll"/></div></label>',
                    defaultContent: '',
                    "data": null,
                    orderable: false,
                    className: 'select-checkbox',
            ...
            {   
                ...
                data: function ( row, type, set, meta ) {
                    ...
                    var text = escapeHtml(row.content);
            ...
            {   
                ...
                data: function ( row, type, set, meta ) 
                {
                    ...
                    return '';
                            ...
                            {name: 'lang', title: c4_templateLang('lang'), data: 'lang'},
            {   
 
                sortable : true,
 
                name: 'description',
                title: c4_templateLang('description'),
                data: function ( row, type, set, meta ) {
            ...
            {   
                ...
                name: 'usefullData',
                title: c4_templateLang('usefullData'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.usefullData !== 'string'){
                        return '';
                    }
             
                    var text = escapeHtml(row.usefullData);
            ...
            },
                    {
                        ...
                        data: function (row) {
                            var id = row.c4_template_id;
                            var $link = ``;

                                var $link =`<div class="btn-group" role="group" aria-label="">`;
        
                            //c4_template form button
                            
                            $link += `<a
                               href="` + get_url('showForm/c4_template/' + id) + `" 
                               data-modalsize="lg"
                               data-datatable="table_c4_template"
                               data-modalurl="` + get_url('showForm/c4_template/' + id) + `"
                               data-modaldata='{"c4_template_id":"` + id + `"}'
                               data-action="openformmodal"
                               data-modalview="centermodal"
                               data-modalbackdrop="true"
                               class="btn btn-sm btn-primary"
                               title="` + c4_templateLang('_form_c4_template') + `" 
            ...
            "rowCallback": function (row, data) {
                ...
                .on('select', function (e, dt, type, indexes) {
                    ...
                    $('#batch_c4_template').collapse('show');
                    if (type === 'row') {
                ...
                .on('deselect', function (e, dt, type, indexes) {
                    ...
                    if (type === 'row') {
                        ...
                        if (count === 0) {
                            $('#batch_c4_template').collapse('hide');
                        }
                ...
                .on('draw', function () {
                    ...
                    var $selectAll = $('#c4_templateselectAll');
        ...
        //Form
        $('#form_c4_template').find('.generalSearch').bind("keyup search", function () {
            console.log('Searching..');
            DT1.ajax.reload();
        });

        $('#form_c4_template').find('.formSearch').on('change', function (e) {
    ...
    return {
        ...
        returnLang: function (param, paramsub) {
            return c4_templateLang(param, paramsub);
        },
